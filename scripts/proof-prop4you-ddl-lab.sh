...
apply_files=(
  ...
  "$P4Y_DDL_DIR/leadfinder_group/0006_projection_candidate_review_board.sql"
  "$P4Y_DDL_DIR/leadfinder_group/0007_systemarea_autocomplete_geography_projection.sql"
